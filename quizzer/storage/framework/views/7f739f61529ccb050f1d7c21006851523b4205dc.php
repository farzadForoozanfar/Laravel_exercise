                                    ...
                                    <div class="modal-body">
                                        <form  action="/add" method="post">
                                            ...
                                            <div class="form-floating mb-3 ">
                                                <input required type="text" class="form-control" name="questiontext" id="floatingInput" placeholder="Question Text">
                                            ...
                                            <div class="">
                                                <button style="width: 100% !important;" type="submit" class="btn btn-primary mt-2 rounded-pill">SAVE</button>
                                            </div>
                                        </form>
                                    </div>
            ...
            <script>
                ...
                function Add_answer()
                {
                    let input_group = `<div class="input-group my-2" id="input_group${answer_cnt}">
                                ...
                                <input required type="text" placeholder="answer ${answer_cnt+1}"  name="answers[]" class="form-control" aria-label="Text input with radio button">
                            </div>`;
...
<?php /**PATH C:\Users\win10\Desktop\New folder\quizzer\resources\views/Admin.blade.php ENDPATH**/ ?>